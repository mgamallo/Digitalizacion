...
public class VentanaAñadirDocumentos extends JDialog{
	...
	JButton nombreDocumentoJB = new JButton("Añadir Nombre");
	...
	VentanaAñadirDocumentos( final String tipoDeNovedad /* final ArrayList<String> listaNovedades */ ){
	...
	//	this.setResizable(false);
		...
		if(tipoDeNovedad.contains("Documento")){
			avisoJL = new JLabel(" A Ñ A D I R   D O C U M E N T O ");
		}else{
			avisoJL = new JLabel(" A Ñ A D I R   N U E V O  M O D E L O  ");
		}
...
//		conf05.insets = new Insets(10,0,0,5);
	    ...
	    nombreDocumentoJB.addActionListener(new ActionListener(){
	    	public void actionPerformed(java.awt.event.ActionEvent evt) {
	    		AñadirMetadatos meta = new AñadirMetadatos(tipoDeNovedad,false,null);
