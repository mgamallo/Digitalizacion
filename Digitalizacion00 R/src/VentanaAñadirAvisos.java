...
public class VentanaAñadirAvisos extends JDialog{
	...
	VentanaAñadirAvisos( /* final ArrayList<String> listaNovedades */ ){
...
//		conf05.insets = new Insets(10,0,0,5);
	    ...
	    aceptarJB.addActionListener(new ActionListener(){
	    	public void actionPerformed(java.awt.event.ActionEvent evt) {
	    		if(contenidoJTAMensaje.getText().equals("")){
	    			JOptionPane.showMessageDialog(null, "No hay ningún comentario");
	    		}else{
