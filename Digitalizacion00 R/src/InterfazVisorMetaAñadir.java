...
public class InterfazVisorMetaAñadir extends JDialog{
	...
	InterfazVisorMetaAñadir(){
	    ...
	    comboMeta.addActionListener(new java.awt.event.ActionListener() {
	            public void actionPerformed(java.awt.event.ActionEvent evt) {
	            	String[] docmetaDatos;
	            	docmetaDatos = InicioIanus.excel.getDocServicioVisor(comboMeta.getSelectedItem().toString());
	            ...
	            private ArrayList<String> getDocumentosJpg() {
					...
					for(int i=1;i<numFilas;i++){
						for(int j=6;j<11;j++){
							if(InicioIanus.excel.tablaVisor[i][j].toString().contains(comboMeta.getSelectedItem().toString())){
								listaNombreDocumentos.add(InicioIanus.excel.tablaVisor[i][1].toString());
							}
						}
					}
				...
				private ArrayList<String> getRutaJpg() {
					...
					for(int i=1;i<numFilas;i++){
						for(int j=6;j<11;j++){
							if(InicioIanus.excel.tablaVisor[i][j].toString().contains(comboMeta.getSelectedItem().toString())){
								listaRuta.add(InicioIanus.excel.tablaVisor[i][0].toString() + ".jpg");
							}
						}
					}
				...
				private ArrayList<String> getObservaciones() {
					...
					for(int i=1;i<numFilas;i++){
						for(int j=6;j<11;j++){
							if(InicioIanus.excel.tablaVisor[i][j].toString().contains(comboMeta.getSelectedItem().toString())){
							listaObs.add(InicioIanus.excel.tablaVisor[i][5].toString());
							}
						}
					}
	...
	//    comboColor.addItem("Color");
	    ...
	    comboColor.addActionListener(new java.awt.event.ActionListener(){
            ...
            private ArrayList<String> getDocumentosJpg() {
				...
				int numFilas = InicioIanus.excel.tablaVisor.length;
				for(int i=1;i<numFilas;i++){
						if(InicioIanus.excel.tablaVisor[i][3].toString().contains(comboColor.getSelectedItem().toString())){
							listaNombreDocumentos.add(InicioIanus.excel.tablaVisor[i][1].toString());
						}
				}
				return listaNombreDocumentos;
	    ...
	    comboGrafico.addActionListener(new ActionListener(){
	            ...
	            private ArrayList<String> getDocumentosJpg() {
					...
					int numFilas = InicioIanus.excel.tablaVisor.length;
					for(int i=1;i<numFilas;i++){
							if(InicioIanus.excel.tablaVisor[i][4].toString().contains(comboGrafico.getSelectedItem().toString())){
								listaNombreDocumentos.add(InicioIanus.excel.tablaVisor[i][1].toString());
							}
					}
					return listaNombreDocumentos;
	    ...
	    botonSeleccionar.setBackground(Color.pink);
	    botonSeleccionar.addActionListener(new ActionListener(){
	    	public void actionPerformed(java.awt.event.ActionEvent evt) {
	    		InicioIanus.auxRutaImagen = rutaImagenSeleccionada;
	    		dispose();
	    	}
	    });
		...
		panelInferior.add(contObsvLabel,BorderLayout.CENTER);
	...
	public void EventoMouseClicked(final JTable tabla){
		tabla.addMouseListener(new MouseAdapter(){
			...
			public void mousePressed(MouseEvent e){
				...
				rutaImagenSeleccionada = rutaJpgs.get(fil*3 + column);
	...
	DefaultComboBoxModel listaColor(){
		...
		for(int i=1;i<numFilas;i++){
				colores.add(InicioIanus.excel.tablaVisor[i][3].toString());
		}
	...
	DefaultComboBoxModel listaMeta(){
		...
		for(int i=1;i<numFilas;i++){
			for(int j=6;j<11;j++){
				metaDatos.add(InicioIanus.excel.tablaVisor[i][j].toString());
			}
		}
    ...
    private ArrayList<String> getDocumentosJpg(String nombreABuscar) {
		...
		for(int i=1;i<numFilas;i++){
			for(int j=6;j<12;j++){
				if(InicioIanus.excel.tablaVisor[i][j].toString().toLowerCase().contains(nombreABuscar.toLowerCase())){
					listaNombreDocumentos.add(InicioIanus.excel.tablaVisor[i][1].toString());
				}
			}
		}
