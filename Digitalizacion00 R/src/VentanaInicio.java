...
public class VentanaInicio extends javax.swing.JDialog {
    ...
    public VentanaInicio(java.awt.Frame parent, boolean modal) {
        ...
        InicioIanus.servicios = InicioIanus.excel.listaServicios;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (InicioIanus.numeroPantallas == 1){
        	InicioIanus.coordenadasIanus = new int[6][3];
            InicioIanus.coordenadasIanus = InicioIanus.excel.getCoordenadasIanus(12);
        }else{
            InicioIanus.coordenadasIanus = new int[12][3];
            if(InicioIanus.nombrePc.equals("hpchpMAHC14p")){
            	System.out.println("El pc es el " + InicioIanus.nombrePc);
            	InicioIanus.coordenadasIanus = InicioIanus.excel.getCoordenadasIanus(12);
            }
            else{
            	InicioIanus.coordenadasIanus = InicioIanus.excel.getCoordenadasIanus(12);
        ...
        if(InicioIanus.documentacion != 0 && InicioIanus.documentacion != 3){
        	...
        	jlistaUsuarios.setModel(InicioIanus.excel.listaUsuariosUrg);
        }

        jlistaUsuarios.setSelectedIndex(0);
        jlistaUsuarios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	InicioIanus.usuario = jlistaUsuarios.getSelectedItem().toString();
        ...
        jBotonNUsuario.addActionListener(new ActionListener(){
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	InicioIanus.usuario = JOptionPane.showInputDialog(jPanel1, "Escribe tu nombre", "", JOptionPane.QUESTION_MESSAGE);
